...
// Sample data for cards, including background image URLs
const cardData = [
  {
...
const Card = () => {
  ...
  return (
    <div className="flex mt-4 flex-col w-full items-center p-5 justify-center bg-white ">
      ...
      <SecondCard/>
      <div className='mt-10'>
      <button className="bg-indigo-500 text-white px-4 py-4 rounded-md hover:bg-indigo-600 text-xl">See More Use Cases</button> 
      </div>
    </div>
  )
}
